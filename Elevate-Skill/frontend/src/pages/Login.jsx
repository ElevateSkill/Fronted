      ...
      <div className="w-full lg:w-7/12 flex flex-col items-center justify-center p-8 lg:p-24 relative">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            <button className="flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-[#15c8fb]/50 transition-all group shadow-sm">
              <Chrome size={18} className="text-[#15c8fb]" />
              <span className="text-xs font-black uppercase tracking-widest">Google</span>
            </button>
            <button className="flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-[#17c966]/50 transition-all group shadow-sm">
          ...
          <div className="relative mb-10">
            ...
            <div className="relative flex justify-center"><span className="px-4 bg-[#f8fafc] dark:bg-[#050505] text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Manual_Entry</span></div>
          </div>
          ...
          <form className="space-y-6" onSubmit={e => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#15c8fb]" size={16} />
                  <input type="text" placeholder="Hachalu Hundessa" className="w-full pl-12 pr-4 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#15c8fb]/20 transition-all" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input type="email" placeholder="dev@astu.edu" className="w-full pl-12 pr-4 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#15c8fb]/20 transition-all" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#17c966]" size={16} />
                  <input type="tel" placeholder="+251 9..." className="w-full pl-12 pr-4 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#17c966]/20 transition-all" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Ticket className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#17c966]" size={16} />
                  <input type="text" placeholder="AX-001" className="w-full pl-12 pr-4 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#17c966]/20 transition-all font-mono" />
                </div>
              </div>
            </div>
