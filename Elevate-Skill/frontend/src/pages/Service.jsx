  ...
  return (
    <div id="services" className="relative w-full bg-[#f8fafc]  py-16 md:py-24 sm:px-6 overflow-hidden transition-colors duration-500 font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10 p-10 bg-white .04] border border-slate-100  backdrop-blur-3xl shadow-xl shadow-slate-500/5">
            ...
            <motion.div 
              ...
              layout
               className={`group relative overflow-hidden rounded-[2.5rem] transition-all duration-500 border-2 ${
                ...
                : 'bg-white/70 .03] border-transparent hover:border-slate-200 :border-white/10 shadow-xl shadow-black/5 '
              }`}
            >
              {/* Image Header */}
              ...
              <div className="p-8">
                ...
                <button 
                  ...
                  className={`flex items-center justify-between w-full p-4 rounded-2xl transition-all duration-300 ${
                    ...
                    : 'bg-slate-100  text-slate-700  hover:bg-slate-200 :bg-white/10'
                  }`}
                >
