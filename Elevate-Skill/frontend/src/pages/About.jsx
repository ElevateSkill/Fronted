...
const About = () => {
  return (
    <div className="min-h-screen bg-[#050505] transition-colors duration-500 overflow-x-hidden selection:bg-[#15c8fb]/30 selection:text-white">
      ...
      <section className="bg-[#080808] py-32 md:py-40">
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          <div className="text-center mb-24">
            ...
            <h2 className="text-4xl md:text-7xl font-black text-white tracking-tight">OUR PROTOCOLS</h2>
          </div>
      ...
      <section className="py-40 md:py-60 px-6 lg:px-20 text-center relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={gr3} className="w-full h-full object-cover opacity-[0.05]" alt="" />
        </div>
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
          <div className="w-24 h-[2px] bg-gradient-to-r from-[red] to-[#f89f29] mx-auto" />
          <h2 className="text-3xl md:text-6xl font-extralight italic text-white leading-[1.2] tracking-tight">
          ...
          >
            <p className="text-white font-black uppercase tracking-[0.6em] text-[10px]">Lidetu Tesfaye</p>
      ...
      {/* 5. NEWS & GALLERY */}
      <section className="py-32 md:py-40 px-6 max-w-7xl mx-auto border-t border-white/5">
         <div className="flex justify-between items-end mb-20">
            <div>
              <span className="text-[#f89f29] font-black uppercase tracking-[0.3em] text-xs mb-2 block">Updates</span>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white">Journal / 26</h2>
            </div>
...
const ValueCard = ({ Icon, title, desc }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className="bg-[#0a0a0a] p-10 md:p-12 border border-white/5 hover:border-[red]/30 transition-all duration-500 group"
  >
    ...
    <h4 className="text-white font-black uppercase text-xs tracking-[0.2em] mb-4">{title}</h4>
...
const NewsItem = ({ date, tag, title }) => (
  <div className="group cursor-pointer">
    ...
    <div className="flex justify-between items-start">
        <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[red] group-hover:to-[#f89f29] transition-all uppercase leading-tight tracking-tight max-w-[80%]">
        {title}
        </h3>
