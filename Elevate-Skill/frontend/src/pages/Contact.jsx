      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white tracking-tight">
            Get In{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f89f29] to-[#15c8fb]">Touch</span>
          </h2>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-5">
              {[
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gray-200 dark:bg-white/10 flex items-center justify-center text-[#15c8fb] group-hover:bg-[#15c8fb] group-hover:text-white transition-all duration-300">
                    {item.icon}
                  </div>
                  <div>
              ...
              <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" placeholder="John Doe" className="w-full px-4 py-3.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-sm focus:outline-none focus:border-[#15c8fb]/50 transition-all placeholder:text-gray-400 dark:placeholder:text-white/20" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea rows={4} placeholder="Tell us more about your project..." className="w-full px-4 py-3.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-sm focus:outline-none focus:border-[#15c8fb]/50 transition-all placeholder:text-gray-400 dark:placeholder:text-white/20 resize-none" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-[#f89f29] to-[#15c8fb] text-white font-black text-xs rounded-xl hover:brightness-110 transition-all uppercase tracking-wider flex items-center justify-center gap-3 shadow-xl"
                  >
