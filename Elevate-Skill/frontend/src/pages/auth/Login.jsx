  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#07090d] via-[#0a0e14] to-[#111827] text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative overflow-hidden border border-white/10 bg-[#0c111b]/90 p-6 shadow-[0_30px_120px_rgba(15,23,42,0.16)] backdrop-blur-2xl sm:p-8">
            ...
            <div className="mb-8 pt-10">
              <div className="mb-4 inline-flex items-center gap-2 border border-[#15c8fb]/15 bg-[#ff9d00]/8 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-[#ff9d00]">
                Elevate Skill
              </div>
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  className="mb-6 flex items-start gap-3 border border-red-500/30 bg-red-500/20 p-4 text-sm text-red-400"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-[0.28em] text-gray-400">Email</label>
                <div className="relative group">
                  <Mail size={18} className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 transition-colors group-focus-within:text-[#ff9d00]" />
                  <input
                    type="email"
                    value={email}
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 transition hover:text-slate-200"
                  >
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-[0.35em] text-gray-500">
              <span>Fast</span>
              <span>•</span>
              <span>Clear</span>
              <span>•</span>
