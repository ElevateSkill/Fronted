...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['is_active', 'is_published'], name='courses_cou_is_acti_8e0d16_idx'), models.Index(fields=['category'], name='courses_cou_categor_108713_idx'), models.Index(fields=['-created_at'], name='courses_cou_created_c141ec_idx')],
            },
        ),
    ]
